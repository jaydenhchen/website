...
`].filter(So).join(`
`)),o=Ru(o),o=Zf(o,e),o=jf(o,e),a=Ru(a),a=Zf(a,e),a=jf(a,e),o=Jf(o),a=Jf(a),e.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+p);const M=S+m+o,v=S+p+a,A=qf(i,i.VERTEX_SHADER,M),w=qf(i,i.FRAGMENT_SHADER,v);i.attachShader(_,A),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(P){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(A).trim(),W=i.getShaderInfoLog(w).trim();let $=!0,Y=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,A,w);else{const X=Kf(i,A,"vertex"),H=Kf(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`,dT={uniforms:{tDiffuse:{value:null},uTime:{value:0},uMouse:{value:{x:0,y:0}},uProgress:{value:0},uShock:{value:0},uRes:{value:{x:1,y:1}},uAberration:{value:.0028},uFlash:{value:0},uInvert:{value:0},uMono:{value:0},uWave:{value:0},uPunch:{value:0},uShake:{value:0},uHit:{value:{x:.5,y:.5}}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
